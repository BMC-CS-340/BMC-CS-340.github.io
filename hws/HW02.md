...
due_date: 2024-10-04 23:59:00EDT
...
name. Your `Node` class should hold data of type `Name`. You can design your `Name` class any way you like, but be sure to include a `Name(String)` constructor for compatability with the autograder. 
